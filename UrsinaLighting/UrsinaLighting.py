...
if __name__ == "__main__":
    ...
    player = FirstPersonController(y = 9)

    Texture.default_filtering = 'mipmap'
    texture = Texture("textures/mud_diff.jpg")
    specTexture = Texture("textures/mud_spec.png")
    normTexture = Texture("textures/mud_norm.exr")

    ground = LitObject(model = "plane", scale = 10, texture = texture, specularMap = specTexture, normalMap = normTexture)
    colliderfloor = Entity(model = "plane", scale = 10, collider = "mesh", texture = "empty", y = -.1)
